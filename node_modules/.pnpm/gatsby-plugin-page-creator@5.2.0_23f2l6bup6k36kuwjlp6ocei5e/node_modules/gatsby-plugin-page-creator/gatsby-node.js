...
Please pick a path to an existing directory.`
    ...
    pluginInstance.getPathFromAResolvedNode = function getPathFromAResolvedNode({
      ...
      const {
        derivedPath
      } = (0, _derivePath.derivePath)(filePath, node, reporter, slugifyOptions);
    ...
    pluginInstance.createAPageFromNode = function createAPageFromNode({
      ...
      const hasTrailingSlash = derivedPath.endsWith(`/`);
      const path = (0, _gatsbyPageUtils.createPath)(derivedPath, hasTrailingSlash, true); // We've already created a page with this path
      ...
      return {
        gatsbyPath: {
          ...
          resolve: (source, {
            ...
            const {
              derivedPath
            } = (0, _derivePath.derivePath)(filePath, sourceCopy, reporter, slugifyOptions);
            const hasTrailingSlash = derivedPath.endsWith(`/`);
            const path = (0, _gatsbyPageUtils.createPath)(derivedPath, hasTrailingSlash, true);
            const modifiedPath = (0, _gatsbyPageUtils.applyTrailingSlashOption)(path, trailingSlash);
            return modifiedPath;
